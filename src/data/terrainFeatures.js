...
export const BIOME_TERRAIN = {
  ...
  // ─── DUNGEON TERRAIN PROFILES ───
  dungeon_mine: {
    terrainType: "dungeon",
    heightProfile: "tunnels",
    roadStyle: "dirt",
    waterFeatures: ["puddle"],
  ...
  dungeon_crypt: {
    ...
    roadCount: 1,
    cliffThreshold: 1.0,
    ambientParticles: ["ghost_wisp", "dust_mote"],
    isDungeon: true,
  },
  dungeon_cave: {
    terrainType: "dungeon",
    heightProfile: "cavern",
    roadStyle: "dirt",
    waterFeatures: ["puddle", "coral_pool"],
    ...
    roadCount: 0,
    cliffThreshold: 0.8,
    ambientParticles: ["glow_mote", "bubble_ground"],
    isDungeon: true,
  },
  dungeon_ruins: {
    terrainType: "dungeon",
    ...
    roadCount: 2,
    cliffThreshold: 1.0,
    ambientParticles: ["dust_mote", "glow_mote"],
    isDungeon: true,
  },
};
