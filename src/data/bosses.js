export const BOSSES = [
  {
    ...
    minions: { type: "Byk", count: 2, interval: 8000, hp: 40, damage: 6, bodyType: "quadruped", combatStyle: "melee", speed: 0.05, emoji: "🐃" },
  },
  {
    id: "vampire_lord",
    ...
    minions: { type: "Gangster", count: 3, interval: 7000, hp: 25, damage: 5, bodyType: "humanoid", combatStyle: "melee", speed: 0.06, emoji: "🗡️" },
  },
  {
    id: "volcano_dragon",
    ...
    minions: { type: "Macka", count: 2, interval: 10000, hp: 60, damage: 10, bodyType: "serpent", combatStyle: "melee", speed: 0.04, emoji: "🦑" },
  },
  {
    id: "lich",
    ...
    minions: { type: "Szkielet Pirata", count: 3, interval: 8000, hp: 50, damage: 8, bodyType: "humanoid", combatStyle: "melee", speed: 0.04, emoji: "💀" },
  },
  {
    id: "cosmic_titan",
    name: "Złoty Cesarz",
    ...
    minions: { type: "Złoty Strażnik", count: 2, interval: 9000, hp: 80, damage: 12, bodyType: "humanoid", combatStyle: "ranged", speed: 0.03, emoji: "✨" },
  },
];
