...
export const SPELLS = [
  { id: "fireball",  icon: "dynamite", name: "Dynamit",        color: "#ff6020", colorLight: "#ffb060", desc: "Rzut dynamitem w łuku — eksploduje przy trafieniu (celuj!)",     manaCost: 0,  cooldown: 3000, damage: 25, element: "fire", learned: true, skillshot: true, ammoCost: { type: "dynamite", amount: 1 } },
  { id: "lightning",  icon: "sniper", name: "Strzał Snajpera", color: "#f0e060", colorLight: "#fffff0", desc: "Szybki precyzyjny strzał — wąski pocisk (celuj!)",        manaCost: 12, cooldown: 5000, damage: 35, element: "lightning", learned: true, skillshot: true },
  { id: "icelance",   icon: "harpoon", name: "Harpun",          color: "#40c0ff", colorLight: "#c0f0ff", desc: "Harpun przeszywa pierwszego wroga na wylot (celuj!)",                manaCost: 0,  cooldown: 2500, damage: 18, element: "ice", learned: true, skillshot: true, ammoCost: { type: "harpoon", amount: 1 } },
  { id: "holybeam",   icon: "cannon", name: "Strzał z Armaty",      color: "#d4a030", colorLight: "#fff8d0", desc: "Wolna kula armatnia z obrażeniami obszarowymi (celuj!)",            manaCost: 15, cooldown: 6000, damage: 40, element: "holy", learned: true, skillshot: true, ammoCost: { type: "cannonball", amount: 1 } },
  ...
  { id: "meteor",    icon: "cannon", name: "Salwa Armatnia",  color: "#ff4020", colorLight: "#ff8060", desc: "Zaznacz obszar — po 1s spada salwa (celuj w ziemię!)",                      manaCost: 0, cooldown: 8000, damage: 50, element: "fire", learned: false, aoe: true, skillshot: true, ammoCost: { type: "cannonball", amount: 2 } },
  ...
  { id: "drain",     icon: "pirateRaid", name: "Piracki Haracz",  color: "#c02060", colorLight: "#ff80a0", desc: "Okrada wroga i leczy wykonawcę (celuj!)",                manaCost: 0, cooldown: 5000, damage: 28, element: "shadow", learned: false, skillshot: true, ammoCost: { type: "dynamite", amount: 1 } },
  { id: "chainlightning", icon: "ricochet", name: "Rykoszet",   color: "#e0e040", colorLight: "#ffff80", desc: "Kula odbija się między wrogami (celuj w pierwszego!)",                manaCost: 0, cooldown: 6000, damage: 30, element: "lightning", learned: false, aoe: true, skillshot: true, ammoCost: { type: "harpoon", amount: 2 } },
