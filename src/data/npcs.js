...
export const SPELLS = [
  ...
  { id: "meteor",    icon: "cannon", name: "Salwa Armatnia",  color: "#ff4020", colorLight: "#ff8060", desc: "Trzymaj aby bombardować teren! Kule spadają na krzyżyk (20 dmg, 1 kula + 5 prochu/strzał).",  manaCost: 5, cooldown: 0, damage: 20, element: "fire", learned: false, skillshot: false, isSalva: true, ammoCost: { type: "cannonball", amount: 1 } },
