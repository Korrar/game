...
export const SPELLS = [
  { id: "lightning",  icon: "sniper", name: "Strzał",          color: "#f0e060", colorLight: "#fffff0", desc: "Szybki precyzyjny strzał — wąski pocisk (celuj!)",        manaCost: 12, cooldown: 5000, damage: 35, element: "lightning", learned: true, skillshot: true },
