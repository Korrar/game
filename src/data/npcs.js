...
export const BIOME_NPCS = {
  jungle: [
    ...
    { icon: "skull", name: "Krokodyl Rzeczny", hp: 25, resist: null, loot: { copper: 8 }, rarity: "common", bodyColor: "#4a6a30", armorColor: "#2a4020", bodyType: "lizard", ability: { type: "charge", damage: 8, cooldown: 5500, element: null, range: 20 } },
    { icon: "skull", name: "Dzika Małpa", hp: 20, resist: null, loot: { copper: 5 }, rarity: "common", bodyColor: "#8B6914", armorColor: "#5a4020", bodyType: "primate", ability: { type: "charge", damage: 8, cooldown: 5000, element: null, range: 20 } },
  ...
  island: [
    ...
    { icon: "skull", name: "Krab Kokosowy", hp: 28, resist: null, loot: { copper: 9 }, rarity: "common", bodyColor: "#b04830", armorColor: "#803020", bodyType: "crab", ability: { type: "charge", damage: 8, cooldown: 5000, element: null, range: 18 } },
    { icon: "skull", name: "Waran Wyspowy", hp: 40, resist: null, loot: { copper: 14 }, rarity: "uncommon", bodyColor: "#5a6a40", armorColor: "#3a4a28", bodyType: "lizard", ability: { type: "charge", damage: 10, cooldown: 5000, element: null, range: 22 } },
    ...
    { icon: "skull", name: "Ośmiornica", hp: 35, resist: "ice", loot: { copper: 12 }, rarity: "uncommon", bodyColor: "#8a4060", armorColor: "#602040", bodyType: "tentacle", ability: { type: "poisonSpit", damage: 7, cooldown: 3500, element: "shadow", range: 22 } },
  ],
  desert: [
  ...
  volcano: [
    ...
    { icon: "skull", name: "Ognisty Salamander", hp: 40, resist: "fire", loot: { copper: 14 }, rarity: "uncommon", bodyColor: "#c04020", armorColor: "#902010", bodyType: "lizard", ability: { type: "fireBreath", damage: 8, cooldown: 4000, element: "fire", range: 18 } },
  ],
  summer: [
    ...
    { icon: "star", name: "Orzeł Łowca", hp: 35, resist: null, loot: { copper: 12 }, rarity: "uncommon", bodyColor: "#c0a020", armorColor: "#806010", bodyType: "bird", ability: { type: "poisonSpit", damage: 6, cooldown: 3500, element: "shadow", range: 20 } },
  ...
  mushroom: [
    { icon: "skull", name: "Nietoperz Jaskiniowy", hp: 35, resist: null, loot: { copper: 12 }, rarity: "uncommon", bodyColor: "#8060a0", armorColor: "#504070", bodyType: "bird", ability: { type: "shadowBolt", damage: 7, cooldown: 4000, element: "shadow", range: 22 } },
  ...
  swamp: [
    { icon: "skull", name: "Aligator", hp: 30, resist: "ice", loot: { copper: 10 }, rarity: "common", bodyColor: "#506030", armorColor: "#304020", bodyType: "lizard", ability: { type: "charge", damage: 12, cooldown: 6000, element: null, range: 25 } },
  ...
  sunset_beach: [
    { icon: "skull", name: "Krab Plażowy", hp: 22, resist: null, loot: { copper: 7 }, rarity: "common", bodyColor: "#c05030", armorColor: "#903820", bodyType: "crab", ability: { type: "charge", damage: 6, cooldown: 4500, element: null, range: 18 } },
    ...
    { icon: "water", name: "Meduza Brzegowa", hp: 30, resist: "ice", loot: { copper: 10 }, rarity: "common", bodyColor: "#e0a0c0", armorColor: "#c070a0", bodyType: "tentacle", ability: { type: "poisonSpit", damage: 7, cooldown: 4000, element: "shadow", range: 20 } },
    ...
    { icon: "skull", name: "Krab Pustelnik", hp: 32, resist: null, loot: { copper: 11 }, rarity: "common", bodyColor: "#c08050", armorColor: "#905830", bodyType: "crab", ability: { type: "charge", damage: 9, cooldown: 4500, element: null, range: 18 } },
    { icon: "skull", name: "Płaszczka Plażowa", hp: 28, resist: "ice", loot: { copper: 10 }, rarity: "common", bodyColor: "#4070a0", armorColor: "#204870", bodyType: "fish", ability: { type: "poisonSpit", damage: 8, cooldown: 4000, element: "shadow", range: 20 } },
  ...
  bamboo_falls: [
    ...
    { icon: "skull", name: "Małpa Gibbon", hp: 25, resist: null, loot: { copper: 8 }, rarity: "common", bodyColor: "#8a6a30", armorColor: "#604a18", bodyType: "primate", ability: { type: "charge", damage: 7, cooldown: 3500, element: null, range: 20 } },
    ...
    { icon: "skull", name: "Jaszczurka Szmaragdowa", hp: 35, resist: null, loot: { copper: 12 }, rarity: "uncommon", bodyColor: "#30b060", armorColor: "#208040", bodyType: "lizard", ability: { type: "poisonSpit", damage: 7, cooldown: 4000, element: "shadow", range: 20 } },
  ],
  blue_lagoon: [
    { icon: "skull", name: "Turkusowy Krab", hp: 26, resist: "ice", loot: { copper: 8 }, rarity: "common", bodyColor: "#20a0a0", armorColor: "#107070", bodyType: "crab", ability: { type: "charge", damage: 7, cooldown: 4500, element: null, range: 18 } },
    ...
    { icon: "skull", name: "Jadowita Ryba", hp: 20, resist: "ice", loot: { copper: 6 }, rarity: "common", bodyColor: "#e08040", armorColor: "#b06030", bodyType: "fish", ability: { type: "poisonSpit", damage: 6, cooldown: 3500, element: "shadow", range: 18 } },
    { icon: "skull", name: "Morski Jeż", hp: 24, resist: "ice", loot: { copper: 8 }, rarity: "common", bodyColor: "#302060", armorColor: "#1a1040", bodyType: "tentacle", ability: { type: "poisonSpit", damage: 5, cooldown: 3000, element: "shadow", range: 16 } },
  ...
  olympus: [
    ...
    { icon: "star", name: "Gryfon Olimpijski", hp: 70, resist: null, loot: { silver: 1, copper: 15 }, rarity: "epic", bodyColor: "#c4a040", armorColor: "#8a7020", bodyType: "bird", ability: { type: "charge", damage: 18, cooldown: 5500, element: null, range: 32 } },
    { icon: "skull", name: "Kamienny Gargulec", hp: 50, resist: "fire", loot: { copper: 16 }, rarity: "uncommon", bodyColor: "#808080", armorColor: "#505050", bodyType: "humanoid", ability: { type: "charge", damage: 12, cooldown: 5000, element: null, range: 22 } },
    { icon: "skull", name: "Minotaur", hp: 85, resist: null, loot: { silver: 2 }, rarity: "epic", bodyColor: "#6a4a30", armorColor: "#3a2818", bodyType: "humanoid", ability: { type: "charge", damage: 20, cooldown: 6000, element: null, range: 35 } },
  ...
  underworld: [
    ...
    { icon: "skull", name: "Harpia", hp: 35, resist: null, loot: { copper: 12 }, rarity: "common", bodyColor: "#706050", armorColor: "#504038", bodyType: "bird", ability: { type: "charge", damage: 10, cooldown: 4000, element: null, range: 24 } },
  ],
  meteor: [
