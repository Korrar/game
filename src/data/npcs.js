...
export const SPELLS = [
  ...
  { id: "holybeam",   icon: "cannon", name: "Strzał z Armaty",      color: "#d4a030", colorLight: "#fff8d0", desc: "Wolna kula armatnia z obrażeniami obszarowymi (celuj!)",            manaCost: 15, cooldown: 6000, damage: 40, element: "holy", learned: false, skillshot: true, ammoCost: { type: "cannonball", amount: 1 } },
